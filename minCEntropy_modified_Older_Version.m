function [max_mem,max_obj,S]=minCEntropy_modified_Older_Version(a,K,sigma_factor,n_run,SS)
...
%   init: Cluster initialisation method.  Can be "random", "basickmeans" or "MATLABkmeans"
