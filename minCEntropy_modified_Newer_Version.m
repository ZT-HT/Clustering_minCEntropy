function [max_mem,max_obj,S]=minCEntropy_modified_Newer_Version(a,K,options)
...
arguments
   ...
   options.n_run (1,1) = 1
   options.SS (:,:) = []
   options.init (1,1) string {mustBeMember(options.init,["random","MATLABkmeans","basickmeans"])} = "MATLABkmeans"
